  ...
  return (
   <div className="bg-gray-900 ">
    <div className="bg-gray-700 w-1/2 h-screen">
      ...
      <h1 className="flex absolute top-96 left-1/4 -translate-x-56 text-yellow-500 font-Anton text-6xl transition-transform-color-text duration-1000 hover:text-yellow-400 hover:text-7xl">Me chamo João Lopes</h1>
      <p className="flex absolute  top-2/4 left-1/4 -translate-x-56 font-Anton text-4xl leading-normal text-white transition-transform-color duration-1000 hover:text-yellow-500 hover:text-5xl hover:leading-loose">
      Seja bem-vindo!<br />
