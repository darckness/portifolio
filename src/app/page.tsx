  ...
  return (
   <div className="bg-gray-900 ">
    <div className="bg-gray-700 w-1/2 h-screen">
      <h1 className="flex absolute top-1/3 left-1/4 -translate-x-8 text-white">Olá</h1>
      <h1 className="flex absolute top-1/3 left-1/4 -translate-x-2/2 text-yellow-500">meu nome é João</h1>
